...
var amazelist = ["Amazebowls", "A healthy vegan truck serving a variety of smoothie bowls and drinks", "Monday-Friday, 8am-6pm", "photo", "link"];
var armandolist = ["Armando's Lunch Truck", "A hearty lunch truck serving sandwiches, fries, burritos, burgers", "Monday-Friday, 7am-7pm", "photo", "link"]
...
var infoDisplay = function(num) {
    ...
    n.innerHTML = masterList[num][0];
    var b = document.createElement("P");
    b.innerHTML = "<i>" + masterList[num][1] + "</i>";
    var h = document.createElement("P");
    h.innerHTML = "<b>Hours: </b>" + masterList[num][2];
    var w = document.createElement("P");
    w.innerHTML = masterList[num][3];
    var l = document.createElement("P")
    l.innerHTML = masterList[num][4];
    ...
    document.getElementById("infoArea").appendChild(w);
